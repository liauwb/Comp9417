...
class NeuralNetwork:
    ...
    def fit(self, X, y):
        ...
        for epoch in range(self.epochs + 1):
           ...
           # print(len(outputs)) 
            ...
            #print(numpy.array(self.weights[0][0]))
            #print("layer input:")
            #print(numpy.array(self.weights[0][:64]).shape)
            ...
            for step in range(self.input_size - 1, -1, - 1):
                ...
                #print(previous_gradients.shape)
    ...
    def forward_propagate(self, X):
        ...
        for step in range(self.input_size):
         ...
         #   print(x.shape)
          #  print(numpy.array(self.weights[0]).shape)
    ...
    def derivatives_of_hidden_layer(self, layer_difference, layer_output, layer_input, weight):
        ...
        #print((self.derivative_of_activation_function(layer_output) *numpy.dot(layer_difference, weight.T)).shape)
